<#
    ...
    --------------------------------------------------------------------------------
     ...
     Generated on:       5/9/2022 9:09 AM
     Generated by:       RMcAvoy
    --------------------------------------------------------------------------------
    .DESCRIPTION
...
"@ -IgnoreWarnings | Out-Null
	...
	$checkedlistbox_apps = New-Object 'System.Windows.Forms.CheckedListBox'
	...
	$checkboxAllowTheLicensingTok = New-Object 'System.Windows.Forms.CheckBox'
...
"@
			...
			forEach ($item in $checkedlistbox_apps.Items)
			{
				if ($item.checked)
				{
					switch ($item.text)
					{
						"Access" {
							$LanguageInfo += '      <ExcludeApp ID="Access" />'
						}
						"OneDrive (Groove - LEGACY)" {
							$LanguageInfo += '      <ExcludeApp ID="Groove" />'
						}
						"OneDrive Desktop" {
							$LanguageInfo += '      <ExcludeApp ID="OneDrive" />'
						}
						"Outlook" {
							$LanguageInfo += '      <ExcludeApp ID="Outlook" />'
						}
						"Publisher"{
							$LanguageInfo += '      <ExcludeApp ID="Publisher" />'
						}
						"Word"{
							$LanguageInfo += '      <ExcludeApp ID="Word" />'
						}
						"Excel"{
							$LanguageInfo += '      <ExcludeApp ID="Excel" />'
						}
						"Skype for Business"{
							$LanguageInfo += '      <ExcludeApp ID="Lync" />'
						}
						"OneNote"{
							$LanguageInfo += '      <ExcludeApp ID="OneNote" />'
						}
						"PowerPoint"{
							$LanguageInfo += '      <ExcludeApp ID="PowerPoint" />'
						}
						"Teams"{
							$LanguageInfo += '      <ExcludeApp ID="Teams" />'
						}
					}
				}
			}
...
"@
		...
		switch ($suite) {
			"Office 365 Apps for Enterprise" {
				...
				$IncludedApps | ForEach-Object {
					...
					$psobj | Add-Member -NotePropertyName "CheckId" -NotePropertyValue $CheckId
					$psobj | Add-Member -NotePropertyName "appName" -NotePropertyValue $Object
					$CheckID++
					$Applications += $PSobj
				}
				
				$checkedlistbox_apps.Enabled = $true
				$checkedlistbox_apps.Items.Clear()
				$checkedlistbox_apps.Items.AddRange($IncludedApps)
				
				forEach ($app in $DefaultChecked)
				{
					$ItemId = $Applications | Where-Object { $_.appName -match $app } | Select-Object -ExpandProperty CheckId
					$checkedlistbox_apps.SetItemChecked($ItemId, $true)
				}
			}
			"Office 365 Apps for Business" {
				$IncludedApps = @("Access",
	...
	$button_JustDownload_Click={
		...
		$process = Start-Process $Toolkit_Exec -ArgumentList "/download `"$DL_XML_Path`"" -Wait -PassThru
		$TimeElapsed = New-TimeSpan -Start $process.StartTime -End $process.ExitTime
		$richtextbox_ProcessInfo.AppendText("$(Get-Date -Format "HH:mm:ss") : Download complete, time elapsed $("$($TimeElapsed.Hours):$($TimeElapsed.Minutes):$($TimeElapsed.Seconds)")`n")
	...
	$button_Install_Click = {
		...
		if ($DLPath)
		{
			...
			$process = Start-Process $Toolkit_Exec -ArgumentList "/configure `"$Install_XML_Path`"" -Wait -PassThru
			$TimeElapsed = New-TimeSpan -Start $process.StartTime -End $process.ExitTime
			$richtextbox_ProcessInfo.AppendText("$(Get-Date -Format "HH:mm:ss") : Install complete, time elapsed $("$($TimeElapsed.Hours):$($TimeElapsed.Minutes):$($TimeElapsed.Seconds)")`n")
	...
	$radiobuttonSharedComputer_CheckedChanged = {
		...
		if ($this.checked)
		{
			$checkboxAllowTheLicensingTok.Enabled = $true
		}
		else
		{
			$checkboxAllowTheLicensingTok.Enabled = $false
			$textbox_TokenPath.Enabled = $false
		}	
	}
	
	$checkboxAllowTheLicensingTok_CheckedChanged={
	...
	$Form_Cleanup_FormClosed=
	{
		...
		try
		{
			...
			$checkboxAllowTheLicensingTok.remove_CheckedChanged($checkboxAllowTheLicensingTok_CheckedChanged)
	...
	$form_365toolkit.AutoScaleDimensions = New-Object System.Drawing.SizeF(8, 17)
	...
	$form_365toolkit.ClientSize = New-Object System.Drawing.Size(619, 452)
	#region Binary Data
...
QmCCCw=='))
	...
	$form_365toolkit.Margin = '3, 3, 3, 3'
	...
	$tabcontrol1.Location = New-Object System.Drawing.Point(0, 30)
	$tabcontrol1.Margin = '4, 4, 4, 4'
	$tabcontrol1.Name = 'tabcontrol1'
	$tabcontrol1.SelectedIndex = 0
	$tabcontrol1.Size = New-Object System.Drawing.Size(619, 422)
	...
	$tabpage_Suite.Controls.Add($checkedlistbox_apps)
	$tabpage_Suite.Controls.Add($labelOfficeSuite)
	$tabpage_Suite.Controls.Add($groupbox1)
	$tabpage_Suite.Location = New-Object System.Drawing.Point(4, 26)
	$tabpage_Suite.Margin = '4, 4, 4, 4'
	$tabpage_Suite.Name = 'tabpage_Suite'
	$tabpage_Suite.Padding = '2, 3, 2, 3'
	$tabpage_Suite.Size = New-Object System.Drawing.Size(611, 392)
	...
	# combobox_suite
	#
	$combobox_suite.Anchor = 'Left, Right'
	...
	$combobox_suite.Location = New-Object System.Drawing.Point(158, 49)
	$combobox_suite.Margin = '4, 4, 4, 4'
	$combobox_suite.Name = 'combobox_suite'
	$combobox_suite.Size = New-Object System.Drawing.Size(448, 25)
	...
	$labelIncludedApps.Location = New-Object System.Drawing.Point(19, 130)
	$labelIncludedApps.Name = 'labelIncludedApps'
	$labelIncludedApps.Size = New-Object System.Drawing.Size(97, 17)
	$labelIncludedApps.TabIndex = 13
	$labelIncludedApps.Text = 'Included Apps'
	#
	# checkedlistbox_apps
	#
	$checkedlistbox_apps.Anchor = 'Top, Bottom, Left, Right'
	$checkedlistbox_apps.CheckOnClick = $True
	$checkedlistbox_apps.Enabled = $False
	$checkedlistbox_apps.FormattingEnabled = $True
	$checkedlistbox_apps.Location = New-Object System.Drawing.Point(154, 130)
	$checkedlistbox_apps.Name = 'checkedlistbox_apps'
	$checkedlistbox_apps.Size = New-Object System.Drawing.Size(452, 184)
	$checkedlistbox_apps.TabIndex = 12
	$tooltip_main.SetToolTip($checkedlistbox_apps, 'Checked applications are included in the office deployment.
Unchecked applications are excluded.')
	#
	# labelOfficeSuite
	#
	$labelOfficeSuite.Anchor = 'Top, Bottom, Left, Right'
	$labelOfficeSuite.AutoSize = $True
	$labelOfficeSuite.Location = New-Object System.Drawing.Point(154, 18)
	$labelOfficeSuite.Name = 'labelOfficeSuite'
	$labelOfficeSuite.Size = New-Object System.Drawing.Size(85, 17)
	...
	$groupbox1.Location = New-Object System.Drawing.Point(6, 7)
	$groupbox1.Margin = '4, 4, 4, 4'
	$groupbox1.Name = 'groupbox1'
	$groupbox1.Padding = '4, 4, 4, 4'
	$groupbox1.Size = New-Object System.Drawing.Size(139, 100)
	...
	# radiobutton_64bit
	#
	$radiobutton_64bit.Location = New-Object System.Drawing.Point(13, 60)
	$radiobutton_64bit.Margin = '4, 4, 4, 4'
	$radiobutton_64bit.Name = 'radiobutton_64bit'
	$radiobutton_64bit.Size = New-Object System.Drawing.Size(118, 31)
	...
	$radiobutton_32bit.Location = New-Object System.Drawing.Point(13, 25)
	$radiobutton_32bit.Margin = '4, 4, 4, 4'
	$radiobutton_32bit.Name = 'radiobutton_32bit'
	$radiobutton_32bit.Size = New-Object System.Drawing.Size(118, 31)
	...
	$tabpage2.Padding = '2, 3, 2, 3'
	$tabpage2.Size = New-Object System.Drawing.Size(611, 392)
	$tabpage2.TabIndex = 1
	...
	$groupbox_Activation.Controls.Add($checkboxAllowTheLicensingTok)
	...
	$groupbox_Activation.Location = New-Object System.Drawing.Point(8, 188)
	$groupbox_Activation.Margin = '4, 4, 4, 4'
	$groupbox_Activation.Name = 'groupbox_Activation'
	$groupbox_Activation.Padding = '4, 4, 4, 4'
	$groupbox_Activation.Size = New-Object System.Drawing.Size(601, 200)
	...
	$linklabelLearnMoreAboutDevice.Location = New-Object System.Drawing.Point(318, 166)
	$linklabelLearnMoreAboutDevice.Name = 'linklabelLearnMoreAboutDevice'
	$linklabelLearnMoreAboutDevice.Size = New-Object System.Drawing.Size(268, 17)
	...
	$radiobutton_deviceBased.Location = New-Object System.Drawing.Point(8, 164)
	$radiobutton_deviceBased.Margin = '4, 4, 4, 4'
	$radiobutton_deviceBased.Name = 'radiobutton_deviceBased'
	$radiobutton_deviceBased.Size = New-Object System.Drawing.Size(116, 21)
	...
	$textbox_TokenPath.Enabled = $False
	$textbox_TokenPath.Location = New-Object System.Drawing.Point(28, 133)
	$textbox_TokenPath.Name = 'textbox_TokenPath'
	$textbox_TokenPath.Size = New-Object System.Drawing.Size(543, 23)
	$textbox_TokenPath.TabIndex = 5
	$tooltip_main.SetToolTip($textbox_TokenPath, 'Network, local, or HTTP path')
	#
	# checkboxAllowTheLicensingTok
	#
	$checkboxAllowTheLicensingTok.Enabled = $False
	$checkboxAllowTheLicensingTok.Location = New-Object System.Drawing.Point(28, 102)
	$checkboxAllowTheLicensingTok.Margin = '4, 4, 4, 4'
	$checkboxAllowTheLicensingTok.Name = 'checkboxAllowTheLicensingTok'
	$checkboxAllowTheLicensingTok.Size = New-Object System.Drawing.Size(290, 23)
	$checkboxAllowTheLicensingTok.TabIndex = 4
	$checkboxAllowTheLicensingTok.Text = 'Allow the licensing token to roam'
	$checkboxAllowTheLicensingTok.UseVisualStyleBackColor = $True
	$checkboxAllowTheLicensingTok.add_CheckedChanged($checkboxAllowTheLicensingTok_CheckedChanged)
	#
	# linklabelLearnMoreAboutShareC
	#
	$linklabelLearnMoreAboutShareC.Anchor = 'Top, Right'
	$linklabelLearnMoreAboutShareC.AutoSize = $True
	$linklabelLearnMoreAboutShareC.Location = New-Object System.Drawing.Point(303, 75)
	$linklabelLearnMoreAboutShareC.Name = 'linklabelLearnMoreAboutShareC'
	$linklabelLearnMoreAboutShareC.Size = New-Object System.Drawing.Size(288, 17)
	...
	$linklabelLearnMoreAboutUserBa.Location = New-Object System.Drawing.Point(334, 35)
	$linklabelLearnMoreAboutUserBa.Name = 'linklabelLearnMoreAboutUserBa'
	$linklabelLearnMoreAboutUserBa.Size = New-Object System.Drawing.Size(255, 17)
	...
	$radiobuttonSharedComputer.Location = New-Object System.Drawing.Point(8, 73)
	$radiobuttonSharedComputer.Margin = '4, 4, 4, 4'
	$radiobuttonSharedComputer.Name = 'radiobuttonSharedComputer'
	$radiobuttonSharedComputer.Size = New-Object System.Drawing.Size(140, 21)
	...
	$radiobuttonUserBased.Location = New-Object System.Drawing.Point(8, 33)
	$radiobuttonUserBased.Margin = '4, 4, 4, 4'
	$radiobuttonUserBased.Name = 'radiobuttonUserBased'
	$radiobuttonUserBased.Size = New-Object System.Drawing.Size(102, 21)
	...
	$richtextbox_eula.Location = New-Object System.Drawing.Point(32, 47)
	$richtextbox_eula.Name = 'richtextbox_eula'
	$richtextbox_eula.Size = New-Object System.Drawing.Size(547, 134)
...
You may not use the service or software if you have not validly acquired a license from Microsoft or its licensed distributors.'
	...
	$checkbox_AcceptEULA.Location = New-Object System.Drawing.Point(8, 18)
	$checkbox_AcceptEULA.Margin = '4, 4, 4, 4'
	$checkbox_AcceptEULA.Name = 'checkbox_AcceptEULA'
	$checkbox_AcceptEULA.Size = New-Object System.Drawing.Size(223, 21)
	...
	$tabpage1.Padding = '2, 3, 2, 3'
	$tabpage1.Size = New-Object System.Drawing.Size(611, 392)
	$tabpage1.TabIndex = 2
	...
	$splitcontainer1.Location = New-Object System.Drawing.Point(2, 3)
	...
	$splitcontainer1.Size = New-Object System.Drawing.Size(607, 386)
	...
	$menustrip_main.Padding = '8, 3, 0, 3'
	$menustrip_main.Size = New-Object System.Drawing.Size(619, 30)
	...
	$viewToolStripMenuItem.Size = New-Object System.Drawing.Size(53, 24)
	$viewToolStripMenuItem.Text = 'View'
	#
	# button_Install
	#
	$button_Install.Anchor = 'Top, Bottom, Right'
	$button_Install.Location = New-Object System.Drawing.Point(486, 10)
	$button_Install.Margin = '4, 4, 4, 4'
	$button_Install.Name = 'button_Install'
	$button_Install.Size = New-Object System.Drawing.Size(114, 65)
	...
	$button_JustDownload.Location = New-Object System.Drawing.Point(364, 8)
	$button_JustDownload.Margin = '4, 4, 4, 4'
	$button_JustDownload.Name = 'button_JustDownload'
	$button_JustDownload.Size = New-Object System.Drawing.Size(114, 65)
	...
	$uIFontSettingsToolStripMenuItem.Size = New-Object System.Drawing.Size(188, 26)
	...
	$richtextbox_ProcessInfo.Location = New-Object System.Drawing.Point(7, 16)
	$richtextbox_ProcessInfo.Margin = '4, 4, 4, 4'
	$richtextbox_ProcessInfo.Name = 'richtextbox_ProcessInfo'
	$richtextbox_ProcessInfo.Size = New-Object System.Drawing.Size(593, 270)
	...
	$exitToolStripMenuItem.Size = New-Object System.Drawing.Size(108, 26)
