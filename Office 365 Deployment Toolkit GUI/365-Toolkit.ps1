...
# Source ID: 71bf8670-c022-45c4-88bb-baf6a5411ce3
# Source File: D:\Personal Git\OfficeDeploymentGui\Office 365 Deployment Toolkit GUI\365-Toolkit.psf
#------------------------------------------------------------------------
...
"@
	...
	function CheckFor-ApplicationUpdates
	{
		param
		(
			[parameter()]
		...
		$GithubReleases = $(Invoke-RestMethod -uri "https://api.github.com/repos/serialscriptr/OfficeDeploymentGui/releases" -Method Get)
		$Releases = $GithubReleases | Select-Object -ExpandProperty tag_name
		$OutOfDate = $false
		
		forEach ($Release in $Releases)
		{
			$ReleaseNumber = $($Release -replace "-alpha" -replace "v")
			if ($ReleaseNumber -gt $ApplicationVersion)
			{
				$ReleaseInfo = $GithubReleases | Where-Object { $_.tag_name -match $Release }
				$OutOfDate = $true
				Break
			}		
		}
		...
		if ($OutOfDate)
		{
			Show-AppUpdaterPrompt_psf -ReleaseURL $ReleaseInfo.html_url -ReleaseNotes $ReleaseInfo.body
		}
		else
		{
			# basic dialog prompt stating no updates found	
		}
	}
	function Show-AppUpdaterPrompt_psf
	{
		...
		(
			...
			$labelOfficeToolkitGUIAppl = New-Object 'System.Windows.Forms.Label'
			...
			$form_Updates.Controls.Add($labelOfficeToolkitGUIAppl)
...
//gAAB//AAD//gAAf/8AAP//gAH//wAA////////AAD///////8AAP///////wAA////////AAAL'))
			...
			# buttonDismiss
			#
			$buttonDismiss.Location = New-Object System.Drawing.Point(553, 278)
			...
			#
			# labelOfficeToolkitGUIAppl
			#
			$labelOfficeToolkitGUIAppl.AutoSize = $True
			$labelOfficeToolkitGUIAppl.Font = [System.Drawing.Font]::new('Microsoft Sans Serif', '11')
			$labelOfficeToolkitGUIAppl.Location = New-Object System.Drawing.Point(23, 19)
			$labelOfficeToolkitGUIAppl.Margin = '5, 0, 5, 0'
			$labelOfficeToolkitGUIAppl.Name = 'labelOfficeToolkitGUIAppl'
			$labelOfficeToolkitGUIAppl.Size = New-Object System.Drawing.Size(425, 26)
			$labelOfficeToolkitGUIAppl.TabIndex = 2
			$labelOfficeToolkitGUIAppl.Text = 'Office Toolkit GUI application update found'
			#
			# label_ReleaseNotes
			#
...
ZW0uRHJhd2luZy5JY29uAgAAAAhJY29uRGF0YQhJY29uU2l6ZQcEAhNTeXN0ZW0uRHJhd2luZy5T
aXplAgAAAAIAAAAJAwAAAAX8////E1N5c3RlbS5EcmF3aW5nLlNpemUCAAAABXdpZHRoBmhlaWdo
dAAACAgCAAAAAAEAAAABAAAPAwAAACM9AAACAAABAAEAAAAAAAEAIAANPQAAFgAAAIlQTkcNChoK
...
QmCCCw=='))
	...
	$labelIncludedApps.Location = New-Object System.Drawing.Point(24, 153)
	...
	$checkedlistbox_apps.Location = New-Object System.Drawing.Point(192, 153)
	$checkedlistbox_apps.Margin = '5, 5, 5, 5'
	$checkedlistbox_apps.Name = 'checkedlistbox_apps'
	$checkedlistbox_apps.Size = New-Object System.Drawing.Size(564, 214)
...
Unchecked applications are excluded.')
	...
	#
	$checkboxAllowTheLicensingTok.Enabled = $False
	$checkboxAllowTheLicensingTok.Location = New-Object System.Drawing.Point(35, 120)
	$checkboxAllowTheLicensingTok.Margin = '5, 5, 5, 5'
	$checkboxAllowTheLicensingTok.Name = 'checkboxAllowTheLicensingTok'
	$checkboxAllowTheLicensingTok.Size = New-Object System.Drawing.Size(362, 27)
...
You may not use the service or software if you have not validly acquired a license from Microsoft or its licensed distributors.'
	...
	$button_Install.Location = New-Object System.Drawing.Point(612, 18)
	$button_Install.Margin = '5, 5, 5, 5'
	$button_Install.Name = 'button_Install'
	$button_Install.Size = New-Object System.Drawing.Size(142, 58)
	...
	$button_JustDownload.Location = New-Object System.Drawing.Point(460, 18)
	$button_JustDownload.Margin = '5, 5, 5, 5'
	$button_JustDownload.Name = 'button_JustDownload'
	$button_JustDownload.Size = New-Object System.Drawing.Size(142, 58)
	...
	$richtextbox_ProcessInfo.Location = New-Object System.Drawing.Point(9, 19)
	$richtextbox_ProcessInfo.Margin = '5, 5, 5, 5'
	$richtextbox_ProcessInfo.Name = 'richtextbox_ProcessInfo'
	$richtextbox_ProcessInfo.Size = New-Object System.Drawing.Size(745, 311)
	...
	$aboutToolStripMenuItem.Size = New-Object System.Drawing.Size(74, 29)
